...
function setNodeColor(nodeDiv, type) {
  ...
  nodeDiv.innerHTML = ""; // clear previous icon

  if (type === "start") {
    nodeDiv.classList.add("start-node");
    nodeDiv.innerHTML = '<i class="bi bi-caret-right-fill"></i>';
  } 
  else if (type === "end") {
    nodeDiv.classList.add("end-node");
    nodeDiv.innerHTML = '<i class="bi bi-flag-fill"></i>';
  } 
  else if (type === "wall") {
